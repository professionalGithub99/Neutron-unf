...
/*  vector<double> en = {0.5,3.2,6.2};
  ...
  vector<double> en = {0.3,1.5,3.7,5.9};
  vector<double>  w = {10.5,20,10,20};
  ...
  // loop over number of iterations for unfolding
s.plotInputSpectrum("lightOutput");
s.plotAnswer("neutronEn");
uncert=new UNFOLD::UNCERT(&s,260,en,w);
Eigen::MatrixXf reconstMtx= uncert->binGeneration();
Eigen::MatrixXf simMtx= uncert->unfoldReconstructed();
uncert->plotSimulatedMeans("Neutron Unc");
...
/*uncert->plotBinNumber(26,simMtx,"twijesting","testing2");
uncert->plotBinNumber(27,simMtx,"jsjesting","testing2");
uncert->plotBinNumber(28,simMtx,"jsidjijdsdjsting","testing2");
uncert->plotBinNumber(29,simMtx,"jsidjg","testing2");
uncert->plotBinNumber(30,simMtx,"jsijjjesting","testing2");*/
